<template>
  <div class="dropleftBody">
    ...
    <div id="myDropleft" class="dropleft content">
      ...
      <button class="item" v-on:click="clickItem">Third item</button>
      <button class="item disabled" v-on:click="clickItem" disabled>
        Fourth item
      </button>
    </div>
  </div>
...
export default {
  ...
  methods: {
    dropLeft (event) {
      document.getElementById('myDropleft').classList.toggle('show')
    },
    clickItem (event) {
      let i = 0
